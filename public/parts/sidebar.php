<div class="sidebar_container">
    <div class="sidebar_header">
        ...
        <span class="sidebar_text">
            ...
            $negocios = $auth->getNegociosUsuario();
            if ($negocioActivo): 
            ?>
                <?php echo htmlspecialchars($negocioActivo['nombre']); ?>
                <br><small style="opacity: 0.7;"><?php echo count($negocios); ?> negocio<?php echo count($negocios) != 1 ? 's' : ''; ?></small>
            <?php else: ?>
                Inventario
            <?php endif; ?>
        </span>
    ...
    <nav class="sidebar_nav">
        ...
        <a href="gestionar-negocios.php" class="sidebar_nav-item <?php echo ($active_page ?? '') === 'negocios' ? 'active' : ''; ?>">
            <span class="sidebar_icon">
            ...
            <span class="sidebar_text">Negocios</span>
        </a>
